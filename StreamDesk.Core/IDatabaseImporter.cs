...
//----------------------------------------------------------------------------------
// <copyright file="IDatabaseImporter.cs" company="Developers of the StreamDesk Project">
...
namespace StreamDesk.Core {
    public interface IDatabaseImporter {
        ...
        string Name { get; }
        StreamDeskDatabase ImportDatabase(string path);
    }
}
