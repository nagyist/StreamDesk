...
namespace NasuTek.XUL.Runtime
{
	...
	class PromptServiceFactory : nsIFactory
	{
		public static void Register()
		{
			if (!_IsRegistered)
			{
				Xpcom.RegisterFactory(typeof(PromptServiceFactory).GUID, "NasuTek.XUL.Runtime.PromptServiceFactory", "@mozilla.org/embedcomp/prompt-service;1", new PromptServiceFactory());
				_IsRegistered = true;
			}
		}
