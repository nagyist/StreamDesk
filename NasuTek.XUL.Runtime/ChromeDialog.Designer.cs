namespace NasuTek.XUL.Runtime
{
	partial class ChromeDialog
	{
		...
		{
			this.webBrowser = new NasuTek.XUL.Runtime.GeckoWebBrowser();
			this.SuspendLayout();
			// 
			// webBrowser
			// 
			...
			this.webBrowser.WindowSetBounds += new NasuTek.XUL.Runtime.GeckoWindowSetBoundsEventHandler(this.webBrowser_WindowSetBounds);
