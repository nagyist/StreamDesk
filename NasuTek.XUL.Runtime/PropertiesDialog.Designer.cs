namespace NasuTek.XUL.Runtime
{
	partial class PropertiesDialog
	{
		...
		private void InitializeComponent()
		{
			...
			this.pageGeneral = new NasuTek.XUL.Runtime.XPTabPage();
			this.txtTitle = new NasuTek.XUL.Runtime.ReadOnlyTextBox();
			this.lblModifiedDate = new System.Windows.Forms.Label();
			this.txtReferrer = new NasuTek.XUL.Runtime.ReadOnlyTextBox();
			this.lblSize = new System.Windows.Forms.Label();
			this.lblEncoding = new System.Windows.Forms.Label();
			this.lblDocType = new System.Windows.Forms.Label();
			this.lblContentType = new System.Windows.Forms.Label();
			this.txtAddress = new NasuTek.XUL.Runtime.ReadOnlyTextBox();
